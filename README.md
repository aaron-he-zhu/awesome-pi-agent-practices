...
| Raw long-tail leads                    | [npm keyword search](https://www.npmjs.com/search?q=keywords%3Api-package) and [GitHub topics](https://github.com/topics/pi-package) | Upstream self-declared pools with noise and heavy overlap; use them for gap-finding, not trust.                                    |
...
| Upstream npm pool             | [npm <code>keywords:pi-package</code>](https://www.npmjs.com/search?q=keywords%3Api-package) and [Registry API](https://registry.npmjs.org/-/v1/search?text=keywords%3Api-package)                                                                                                                                                                                       | The API reported about 6,490 during the scan, while dynamic full pagination yielded about 5,250 unique objects. Publisher-supplied keywords are noisy and totals move during a crawl.                                                                                                                                               |
...
| [pi-extension-installer](https://www.npmjs.com/package/pi-extension-installer) 1.1.2 · MIT                                                                       | Interactive npm search/install.                                           | No repository metadata was published; identity evidence is weaker.         |
